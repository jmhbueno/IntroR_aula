...
df <- rename(df,sexo = "sexo cod")

# Alterar o nome da variável "Estado Civil"
rename(df,estado_civil = "Estado Civil")
...
```{r}
which(seq(1,by=1,length=10) %in% seq(4,by=1,length=3))
...
df %>% filter(escolaridade == "fundamental", escolaridade == "superior") # NÃO FUNCIONA
