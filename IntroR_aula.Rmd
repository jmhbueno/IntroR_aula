...
Salve o arquivo `imdb.rds` na pasta que você está utilizando para as aulas do R.

Importe o arquivo `imdb.rds` para dentro do R, salvando-o como imdb.
Use o código de importação abaixo:
...
Salve o arquivo world_populations.cvs no diretório que você está utilizando para esta disciplina.
